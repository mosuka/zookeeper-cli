...
public class SetQuotaCommandTest extends ZooKeeperTestBase {
    ...
    public void testExecute() {
        ...
        parameters.put("timeout", timeout);
        parameters.put("path", "/test");
        parameters.put("bytes", 10L);
        parameters.put("num_nodes", -1);

        int statusCode = Command.STATUS_SUCCESS;

        SetQuotaCommand command = new SetQuotaCommand();
        try {
